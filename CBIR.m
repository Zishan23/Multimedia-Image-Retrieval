...
%============= 1. Codes to read the database of images=====================
...
%=4.Codes where a user can select a text / image / audio from the database=
...
%Define parameters to be used in search button
...
%===6. Codes to retrieve / display top-10 relevant documents to the user===
